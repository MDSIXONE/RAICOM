...
la=language()
lianjie_image = Image.open("/home/pi/RaspberryPi-CM5/common/pics/lianjie@2x.png") 
weilianjie_image = Image.open("/home/pi/RaspberryPi-CM5/common/pics/weilianjie@2x.png")
...
def show_controller_help():
    clear_bottom()
    text_lines = [
        (lal["JOYSTICK_HELP"]["MOVE"], 10, 150),
        (lal["JOYSTICK_HELP"]["HEIGHT"], 10, 170),
        (lal["JOYSTICK_HELP"]["TURN"], 10, 190),
        (lal["JOYSTICK_HELP"]["MODES"], 150, 150),
        (lal["JOYSTICK_HELP"]["RK_ADJUST"], 150, 170),
        (lal["JOYSTICK_HELP"]["OFF_ROAD"], 150, 190),
    ]
