...
for anc in [p] + list(p.parents):
    if anc.name == 'RaspberryPi-CM5':
        ...
        break
from uiutils import (Button,dog, color_white, display, splash, 
                          draw, color_black, lcd_draw_string, lcd_rect)
...
app_image = Image.open(os.path.join(BASE_DIR, "pics/app.png")) 
unapp_image = Image.open(os.path.join(BASE_DIR, "pics/unapp.png"))
