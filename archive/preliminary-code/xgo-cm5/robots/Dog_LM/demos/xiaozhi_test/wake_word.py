...
def audio_init(audio_stream=None):
    ...
    if audio_stream:
        ...
        print("唤醒词检测器使用内部音频流")
    return stream
def model_init(model_path="/home/pi/RaspberryPi-CM5/robots/Dog_LM/demos/xiaozhi_test/models/vosk-model-small-cn-0.22/"):
    global sample_rate
    """
    初始化模型
...
if la=="cn":
  model, recognizer = model_init(model_path = "/home/pi/RaspberryPi-CM5/robots/Dog_LM/demos/xiaozhi_test/models/vosk-model-small-cn-0.22/")  
else:
  model, recognizer = model_init(model_path = '/home/pi/RaspberryPi-CM5/robots/Dog_LM/demos/xiaozhi_test/models/vosk-model-small-en-us-0.15/')  
