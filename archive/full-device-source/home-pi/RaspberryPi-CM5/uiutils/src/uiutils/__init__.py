...
#define logos
pics_dir = "/home/pi/RaspberryPi-CM5/common/pics"
...
re_logo = Image.open(os.path.join(pics_dir, "redian@2x.png"))

def get_font(size):
    if size not in _font_cache:
        _font_cache[size] = ImageFont.truetype("/home/pi/RaspberryPi-CM5/common/model/msyh.ttc", size)
