import sys, os,json,gzip,websockets
...
class RealtimeDialogClient:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            if hasattr(self.ws, 'response_headers'):
                ...
                self.logid = "Unknown (response_headers not available)"
                print("Warning: response_headers not available on WebSocket connection")
        except Exception as e:
            self.logid = "Unknown"
            print(f"Error getting logid: {e}")
    ...
    async def say_hello(self) -> None:
        """发送Hello消息"""
        payload = {
            "content": "你好，我是露露，有什么可以帮助你的？" if la == "cn" else "Hello, I'm Lulu. How can I help you?",
        }
