...
import numpy as np
from uiutils import Button,language,lal,dog
...
font2 = ImageFont.truetype("/home/pi/RaspberryPi-CM5/common/model/msyh.ttc", 22)
...
class DogController:
    ...
    def run(self):
        if not self.check_network():
            ...
            self.show_message(lal['STARTUP']['SPEECH'], color=(255, 255, 255))
